...
namespace Profabrica\Breadcrumbs;
...
class Breadcrumbs {
	 ...
	 * @var array
	 */
	protected $container = 'ol';

	/**
	 * Default main container element class.
	 *
	 * @var array
	 */
	protected $defaultContainerClass = 'breadcrumb';
	...
	public function __construct($breadcrumbs = array(), $cssClasses = array())
	{
		...
		if (!$cssClasses) {
			$this->setCssClasses($this->defaultContainerClass);
		} else {
	...
	public function render()
	{
		...
		return '<' . $this->container . ' class="' . $cssClasses . '">' . $this->renderCrumbs() . '</' . $this->container . '>';
	}
